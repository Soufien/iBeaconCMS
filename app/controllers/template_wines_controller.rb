class TemplateWinesController < ApplicationController
  ...
  private
    ...
    def template_wine_params
      params[:template_wine].permit(:name, :taste_notes, :price ,:wine_specs_vintage,:wine_specs_sugar,:wine_specs_appellation, :wine_specs_acid , :wine_specs_alcohol, :wine_specs_ph, :photo_link, :wine_specs_price_description,:url_image_1,:remove_url_image_1, :item_id)
    end
end
